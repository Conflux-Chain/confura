...
func (api *ethDebugAPI) TraceTransaction(
	...
	return api.stateHandler.TraceTransaction(ctx, w3c, txnHash, opts...)
}
...
func (api *ethDebugAPI) TraceBlockByHash(
	...
	w3c := GetEthClientFromContext(ctx)
	return api.stateHandler.TraceBlockByHash(ctx, w3c, blockHash, opts...)
}
...
func (api *ethDebugAPI) TraceBlockByNumber(
	...
	w3c := GetEthClientFromContext(ctx)
	return api.stateHandler.TraceBlockByNumber(ctx, w3c, blockNumber, opts...)
}
...
func (api *ethDebugAPI) TraceCall(
	...
	w3c := GetEthClientFromContext(ctx)
	return api.stateHandler.TraceCall(ctx, w3c, request, blockNumber, opts...)
}
